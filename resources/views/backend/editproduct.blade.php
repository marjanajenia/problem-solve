                            ...
                            <div class="row"> 
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="category_name" id="category_name" placeholder="enter product category" value="{{$product->category_name}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="brand_name">Product brand</label>
                                        <input type="text" class="form-control" name="brand_name" id="brand_name" placeholder="enter brand name" value="{{$product->brand_name}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="description">Product description</label>
                                        <textarea name="description" id="description" cols="30" rows="4" class="form-control" placeholder="enter product description">{{$product->description}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                   <img height="110" src="{{ asset('backend/images/'.$product->image) }}" alt="">
                                    <div class="form-group">

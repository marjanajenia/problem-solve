                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img height="80" src="{{ asset('backend/images/'.$data->image)}}" alt=""></td>
                                            <td>
                                                @if($data->status==1)
                                            ...
                                            <td>
                                                <a href="{{ Route('edit', $data->id) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
                                                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#delete{{ $data->id }}"><i class="fa fa-trash"></i></button>
                                            </td>
                                        </tr>
                                        <!-- Modal -->
